...
import { extractJsonObject, repairControlCharsInJsonStrings, tryParseJson, type ParseResult } from "./jsonExtract.js";
...
// Re-exported for tests that reach into this module. Implementations live in
// server/jsonExtract.ts so chat and session parsing share the same behavior.
export { extractJsonObject, repairControlCharsInJsonStrings, tryParseJson };
